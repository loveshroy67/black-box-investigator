...
function Dashboard({ incidentId, timeline, investigation, latestEvidence, loading, uploading, onInvestigate, onUpload }) {
  ...
  const sourceLabel = investigation?.source === "gemini" ? "Gemini" : investigation?.source === "openrouter" ? "OpenRouter" : investigation?.source === "local" ? "Local fallback" : "Stored result";
